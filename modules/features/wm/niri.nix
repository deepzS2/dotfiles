{inputs, ...}: {
  flake.modules.nixos.niri = {
    ...
    programs.niri.enable = config.settings.wm == "niri";
      ...
      settings = lib.mkIf (wm == "niri") {
        ...
        binds = with config.lib.niri.actions; {
          ...
          "Mod+Shift+D" = {
            ...
            hotkey-overlay.title = "Run an Application: Discord";
          };
          "Mod+Alt+V" = {
            action = spawn "sh" "-c" "cliphist list | rofi -dmenu -display-columns 2 | cliphist decode | wl-copy";
            hotkey-overlay.title = "Run an Application: Discord";
          };
          "Mod+Shift+G" = {
            action = spawn "zen" "--new-tab=\"https://web.whatsapp.com/\"";
            hotkey-overlay.title = "Open Website: WhatsApp";
          };
          "Super+Alt+L" = {
            action = spawn "sheez" "ipc" "call" "lockScreen" "toggle";
          ...
          "Mod+Ctrl+Comma" = {
            action = spawn "sh" "-c" "makoctl mode -t do-not-disturb && makoctl mode | grep -q 'do-not-disturb' && notify-send \"Silenced notifications\" || notify-send \"Enabled notifications\"";
            hotkey-overlay.title = "Dismiss All Notifications";
          };
